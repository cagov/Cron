const { getData_daily_stats_v3 } = require('./daily-stats-v2');
 ...
 */
const doCovidStateDashboardSummaryV2 = async () => {
...
module.exports = {
    doCovidStateDashboardSummaryV2
};
