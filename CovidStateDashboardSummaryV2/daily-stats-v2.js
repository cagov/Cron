...
const path = 'daily-stats-v3.json';
const schemaFileName = "../SQL/CDT_COVID/Daily-stats-v3/schema/schema.json";
const schemaTestGoodFilePath = "../SQL/CDT_COVID/Daily-stats-v3/schema/tests/output/pass/";
const schemaTestBadFilePath = "../SQL/CDT_COVID/Daily-stats-v3/schema/tests/output/fail/";

const getData_daily_stats_v3 = async () => {
  const statResults = await queryDataset(
      {
          metrics: getSQL('CDT_COVID/Daily-stats-v3/Metrics'),
          hospitalizations : getSQL('CDT_COVID/Daily-stats-v3/Hospitalizations')
      }
