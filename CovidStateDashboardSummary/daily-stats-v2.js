...
const path = 'daily-stats-v2-new.json';
...
//   const rowVaccines = resultsVaccines[0];
  ...
  const json = {
      ...
      data: {
          cases: {
              DATE : row['DATE'],
              LATEST_TOTAL_CONFIRMED_CASES : row['LATEST_TOTAL_CONFIRMED_CASES'],
              LATEST_TOTAL_COMBINED_CASES : row['LATEST_TOTAL_COMBINED_CASES'],
              NEWLY_REPORTED_CASES : row['NEWLY_REPORTED_CASES'],
              LATEST_PCT_CH_CASES_REPORTED_1_DAY : roundNumber(100.0*row['LATEST_PCT_CH_CASES_REPORTED_1_DAY'],6),
              LATEST_CONFIDENT_AVG_CASE_RATE_PER_100K_7_DAYS : row['LATEST_CONFIDENT_AVG_CASE_RATE_PER_100K_7_DAYS'],
              LATEST_CONFIDENT_AVG_COMBINED_CASE_RATE_PER_100K_7_DAYS : row['LATEST_CONFIDENT_AVG_COMBINED_CASE_RATE_PER_100K_7_DAYS'],
              LATEST_CONFIDENT_INCREASE_CASE_RATE_PER_100K_7_DAYS : row['LATEST_CONFIDENT_INCREASE_CASE_RATE_PER_100K_7_DAYS'],
              NEWLY_REPORTED_CASES_LAST_7_DAYS : row['NEWLY_REPORTED_CASES_LAST_7_DAYS']
          },
          deaths : {
              DATE : row['DATE'],
              LATEST_TOTAL_CONFIRMED_DEATHS : row['LATEST_TOTAL_CONFIRMED_DEATHS'],
              NEWLY_REPORTED_DEATHS : row['NEWLY_REPORTED_DEATHS'],
              LATEST_CONFIDENT_AVG_DEATH_RATE_PER_100K_7_DAYS : row['LATEST_CONFIDENT_AVG_DEATH_RATE_PER_100K_7_DAYS'],
              LATEST_CONFIDENT_INCREASE_DEATH_RATE_PER_100K_7_DAYS : row['LATEST_CONFIDENT_INCREASE_DEATH_RATE_PER_100K_7_DAYS'],
              LATEST_PCT_CH_DEATHS_REPORTED_1_DAY : roundNumber(100.0*row['LATEST_PCT_CH_DEATHS_REPORTED_1_DAY'],6)
          },
          tests : {
              DATE : row['DATE'],
              LATEST_TOTAL_TESTS_PERFORMED : row['LATEST_TOTAL_TESTS_PERFORMED'],
              LATEST_PCT_CH_TOTAL_TESTS_REPORTED_1_DAY : roundNumber(100.0*row['LATEST_PCT_CH_TOTAL_TESTS_REPORTED_1_DAY'],6),
              LATEST_CONFIDENT_AVG_TOTAL_TESTS_7_DAYS : row['LATEST_CONFIDENT_AVG_TOTAL_TESTS_7_DAYS'],
              NEWLY_REPORTED_TESTS : row['NEWLY_REPORTED_TESTS'],
              NEWLY_REPORTED_TESTS_LAST_7_DAYS : row['NEWLY_REPORTED_TESTS_LAST_7_DAYS'],
              LATEST_CONFIDENT_POSITIVITY_RATE_7_DAYS : row['LATEST_CONFIDENT_POSITIVITY_RATE_7_DAYS'],
              LATEST_CONFIDENT_INCREASE_CASE_RATE_PER_100K_7_DAYS : row['LATEST_CONFIDENT_INCREASE_CASE_RATE_PER_100K_7_DAYS'], //moved to cases
              LATEST_CONFIDENT_INCREASE_DEATH_RATE_PER_100K_7_DAYS : row['LATEST_CONFIDENT_INCREASE_DEATH_RATE_PER_100K_7_DAYS'], //mode to deaths
              LATEST_CONFIDENT_INCREASE_POSITIVITY_RATE_7_DAYS : row['LATEST_CONFIDENT_INCREASE_POSITIVITY_RATE_7_DAYS']
          },
          hospitalizations : {
