select
    ...
    HOSPITALIZED_PATIENTS_CHANGE / NULLIFZERO(HOSPITALIZED_PATIENTS_PREV) AS HOSPITALIZED_PATIENTS_CHANGE_FACTOR,
    ...
    ICU_PATIENTS_CHANGE / NULLIFZERO(ICU_PATIENTS_PREV) AS ICU_PATIENTS_CHANGE_FACTOR,
    ...
    ICU_AVAILABLE_BEDS_CHANGE / NULLIFZERO(ICU_AVAILABLE_BEDS_PREV) AS ICU_AVAILABLE_BEDS_CHANGE_FACTOR,
