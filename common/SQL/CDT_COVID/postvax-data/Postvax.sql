...
SELECT DATE,
    ...
    REPORT_DATE
FROM COVID.PRODUCTION.CDPH_POSTVAX_CASE_HOSP_DEATH_BOOSTED 
WHERE (REPORT_DATE=(select max(REPORT_DATE) from COVID.PRODUCTION.CDPH_POSTVAX_CASE_HOSP_DEATH_BOOSTED)) 
