select
    ...
    SUM(LATEST_COMMON_TOTAL_CONFIRMED_CASES) "total_confirmed_cases",
    SUM(LATEST_COMMON_TOTAL_PROBABLE_CASES) "total_probable_cases",
    ...
    SUM(LATEST_COMMON_TOTAL_CONFIRMED_DEATHS) "total_confirmed_deaths",
    SUM(LATEST_COMMON_TOTAL_PROBABLE_DEATHS) "total_probable_deaths",
