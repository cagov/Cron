select
    ...
    SUM(LATEST_COMMON_TOTAL_CONFIRMED_CASES) "common_total_confirmed_cases",
    SUM(LATEST_COMMON_TOTAL_PROBABLE_CASES) "common_total_probable_cases",
    ...
    SUM(LATEST_COMMON_TOTAL_CONFIRMED_DEATHS) "common_total_confirmed_deaths",
    SUM(LATEST_COMMON_TOTAL_PROBABLE_DEATHS) "common_total_probable_deaths",
