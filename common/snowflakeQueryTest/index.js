 ...
 */
const queryDataset = async (sqlWork, connection, slackPostTS) => {
    if(!connection) {
    ...
    await slackBotReplyPost(slackDebugChannel, slackPostTS, "Getting Connection");
    ...
    await slackBotReplyPost(slackDebugChannel, slackPostTS, "Got Connection");
