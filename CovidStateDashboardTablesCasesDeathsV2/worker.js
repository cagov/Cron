...
const sqlRootPath = '../SQL/CDT_COVID/CovidStateDashboardTablesCasesDeathsTestsV2/';
...
const doCovidStateDashboardTablesCasesDeathsV2 = async () => {
...
module.exports = {
    doCovidStateDashboardTablesCasesDeathsV2
};
